...
import com.example.amazone_database.Service.MerchantStockService;
...
public class MerchantStockController {
    ...
    public ResponseEntity UserAddStocks(@PathVariable Integer productId, @PathVariable Integer merchantId, @PathVariable int amount ) {
